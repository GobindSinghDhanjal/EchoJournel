  ...
  const fetchWeather = async () => {
    try {
      const response = await axios.get(
        `https://api.openweathermap.org/data/2.5/weather?q=mumbai&units=metric&appid=e9680cd3a38940fd4e998a99361dc0d4`
      );
  ...
  return (
    <div className="cardm">
      <div className="card">
        ...
        <div className="mainsub">{weather.name}, India</div>
      </div>
        ...
        <div className="upper">
          ...
          <div className="air">
            <div className="airtext">
              Wind
              <br />{Math.round(weather.wind.speed)} Km/h
            </div>
            <svg
              className="airsvg"
              version="1.1"
